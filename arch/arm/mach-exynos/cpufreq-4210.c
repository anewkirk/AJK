...
static const unsigned int asv_voltage_A[CPUFREQ_LEVEL_END][8] = {
	 ...
	 * @200  :
	 */
	{ 1350000, 1350000, 1275000, 1275000, 1275000, 1225000, 1200000, 1175000 }, //1200MHz
	{ 1325000, 1325000, 1225000, 1225000, 1225000, 1175000, 1150000, 1125000 }, //1100MHz
	{ 1300000, 1250000, 1175000, 1175000, 1175000, 1125000, 1100000, 1075000 }, //1000MHz
	{ 1250000, 1200000, 1125000, 1125000, 1125000, 1075000, 1050000, 1025000 }, // 900MHz
	{ 1200000, 1150000, 1075000, 1075000, 1075000, 1025000, 1000000,  975000 }, // 800MHz
	{ 1150000, 1100000, 1050000, 1050000, 1050000, 1000000,  975000,  950000 }, // 700MHz
	{ 1125000, 1075000, 1025000, 1025000, 1025000,  975000,  950000,  950000 }, // 600MHz
	...
	{ 1025000,  975000,  950000,  950000,  950000,  900000,  900000,  900000 }, // 100MHz
};
...
static void __init set_volt_table(void)
{
	...
	case SUPPORT_1000MHZ:
		for_1000 = true;
		max_support_idx = L0; /* 1000Mhz max */
		break;
	default:
		for_1000 = true;
		max_support_idx = L0; /* 1000Mhz max */
